...
class SkinMLSimple extends SkinTemplate {

	var $skinname = 'mlsimple', $stylename = 'mlsimple',
		$template = 'MLSimpleTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addModuleStyles( 'skins.mlsimple' );
	}
}

class MLSimpleTemplate extends BaseTemplate {
	/**
	...
	public function execute() {
		...
		<div class="mw-jump">
			<a href="#bodyContent"><?php $this->msg( 'mlsimple-skiptocontent' ) ?></a><?php $this->msg( 'comma-separator' ) ?>
			<a href="#search"><?php $this->msg( 'mlsimple-skiptosearch' ) ?></a>
		</div>
 ...
 * Footer
		...
		<div id="primary" class="footer">
			...
			<li class="widget">
				<?php echo $this->msgWikiNoEdit( 'mlsimple-extracontent-column1' ); ?>
			</li>
		...
		<div id="secondary" class="footer">
			...
			<li class="widget">
				<?php echo $this->msgWikiNoEdit( 'mlsimple-extracontent-column2' ); ?>
			</li>
		...
		<div id="ternary" class="footer">
			...
			<li class="widget">
				<?php echo $this->msgWikiNoEdit( 'mlsimple-extracontent-column3' ); ?>
			</li>
